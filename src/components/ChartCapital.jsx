...
export default function ChartCapital(props) {
    useEffect(() => {
       
            ctx = document.getElementById('capitalChart').getContext('2d');
            var data = {}
    ...
    return (
        <div>
            <canvas id="capitalChart" width="500px" height="300px"></canvas>
        </div>
    )
}
